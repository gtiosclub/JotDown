...
//    enum Phase { case idle, thinking, merging, morphing, streaming }
//
...
//        
//        // Animate orb growing as words converge
...
//                   self.cancelPulses()
//                   self.phase = .morphing
//                   // Wait for morph animation then stream
//            
//        }
//    }
//
...
//            let a: CGFloat = orbRadius + 15  // Start spiral beyond orb radius
//            let b: CGFloat = 6.0
//            let dθ: CGFloat = 0.20 // radians
//    
//            for sz in sizes {
